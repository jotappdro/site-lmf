...
const About = () => {
  ...
  // Calculate years since foundation (15/09/2015)
  ...
  const carouselSlides = [
    {
      ...
      rightContent: {
        type: 'text',
        content: 'Imergir totalmente o aluno da PUC-Rio no Mercado Financeiro para que alcance seu máximo potencial, suplementando o ensino fora da sala de aula e preparando-o para o mercado de trabalho.'
      },
      leftContent: {
        type: 'stats',
        stats: [
          {
            number: calculateYearsSinceFoundation(),
            prefix: 'Há ',
            suffix: ' anos',
            description: 'construindo parcerias com o mercado financeiro'
          },
          {
            number: 200,
            prefix: '+',
            description: 'ex-associados formam nossa Rede Alumni'
          },
          {
            number: 100,
            prefix: '+',
            description: 'gestoras e bancos contam com a representatividade da LMF PUC-Rio'
          }
        ]
      }
    },
    {
      ...
      rightContent: {
        type: 'text',
        content: 'Tornar-se uma Organização Estudantil sólida e respeitada no ambiente universitário nacional, e também no mercado de trabalho.'
      },
      leftContent: {
        type: 'stats',
        stats: [
