            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="mb-20">
                ...
                <div className="max-w-4xl mx-auto space-y-8">
                  ...
                  {/* Terça-feira (26/08) */}
                  <div>
                    <h4 className="text-[1.375rem] font-semibold text-primary mb-4">Terça-feira (26/08)</h4>
                    <div className="space-y-4">
                      <div className="flex flex-col md:flex-row md:items-center items-start gap-4 md:gap-6 p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-100">
                        <div className="text-lg font-medium text-primary mb-2 md:mb-0 md:min-w-[60px] text-center">
                          10h30
                  ...
                  {/* Quarta-feira (27/08) */}
                  <div>
                    <h4 className="text-[1.375rem] font-semibold text-primary mb-4">Quarta-feira (27/08)</h4>
                    <div className="space-y-4">
                      <div className="flex flex-col md:flex-row md:items-center items-start gap-4 md:gap-6 p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-100">
                        <div className="text-lg font-medium text-primary mb-2 md:mb-0 md:min-w-[60px] text-center">
                          11h00
                  ...
                  {/* Quinta-feira (28/08) */}
                  <div>
                    <h4 className="text-[1.375rem] font-semibold text-primary mb-4">Quinta-feira (28/08)</h4>
                    <div className="space-y-4">
                      <div className="flex flex-col md:flex-row md:items-center items-start gap-4 md:gap-6 p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-100">
                        <div className="text-lg font-medium text-primary mb-2 md:mb-0 md:min-w-[60px] text-center">
                          10h00
                  ...
                  {/* Sexta-feira (29/08) */}
                  <div>
                    <h4 className="text-[1.375rem] font-semibold text-primary mb-4">Sexta-feira (29/08)</h4>
                    <div className="space-y-4">
                      <div className="flex flex-col md:flex-row md:items-center items-start gap-4 md:gap-6 p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-100">
                        <div className="text-lg font-medium text-primary mb-2 md:mb-0 md:min-w-[60px] text-center">
                          13h30
